...
export default function EditCampaignPage() {
  ...
  const campaignId = params?.id as Id<"economicCampaigns">;
  ...
  const handlePublish = async (
    newStatus: "funding" | "completed" | "rejected"
  ) => {
    setLoading(true);
    try {
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <Input
              ...
              onChange={(e) =>
                setFundingGoal(e.target.value === "" ? "" : Number(e.target.value))
              }
              placeholder="Funding Goal"
            />

            <div className="flex gap-2 mt-3">
              <Button onClick={() => handlePublish("funding")} disabled={loading}>
                Mark Funding
              </Button>
